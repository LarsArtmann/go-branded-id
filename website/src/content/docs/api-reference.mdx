...
All ID operations return wrapped sentinel errors. Match with `errors.Is` to branch on error category.
...
See the [Error Handling guide](/guides/error-handling/) for usage examples.
